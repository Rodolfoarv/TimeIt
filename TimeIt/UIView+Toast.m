...
// activity
static const CGFloat CSToastActivityWidth       = 300;
static const CGFloat CSToastActivityHeight      = 400;
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        titleLabel.frame = CGRectMake(0.0, 0.0, self.bounds.size.width/2, expectedSizeTitle.height);
    }
