...
static NSString* const CLCalendarSelectedDatePrintFormatDefault = @"MMM, d yyyy";
...
-(void)markDateSelected:(NSDate *)date
{
    ...
    if([date isEqualToDate:self.selectedDate]){
       ...
       /* NSString *dateString = strDate;
        ...
        self.theSelectedDateIs = dateFromString;*/
        
        self.theSelectedDateIs = strDate;
        // NSLog(_theSelectedDateIs);
    }
